	...
	return (
		<footer class="border-t border-orange-300">
			<div class="max-w-7xl mx-auto pt-12 px-4 sm:px-6 lg:pt-16 lg:px-8 ">
				<div class="grid sm:grid-cols-0  md:grid-cols-4 gap-8">
					<div class="flex flex-col md:flex-row md:col-span-2  justify-center sm:justify-start  gap-4">
						<div class="flex flex-col space-y-6">
							...
							<div>
								...
								<p class="text-xl  font-bold">011 2 46 46 46</p>
								<p class="text-xl  font-bold">071 2 46 46 46</p>
							</div>
						...
						<div class="flex flex-col space-y-4 md:ml-8">
				...
				<div class="w-full mt-8 border-t border-orange-300">
					<div class="container mx-auto px-2 py-3 flex flex-col sm:flex-row justify-between items-center">
